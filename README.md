...
# WebMonks Technologies | Laravel 8 + Bootstrap 4 

WebMonks Technologies is Admin Panel With Preset of Roles, Permissions, ACL, User Management, Profile Management.
...
Install WebMonks Technologies With Simple Steps

```bash
git clone https://github.com/Damku999/webmonks-laravel-admin.git
cd webmonks-laravel-admin
```
...
If you have any feedback, please reach out to us at webmonks.in@gmail.com


## Support

For support, email webmonks.in@gmail.com or join our facebook chanel https://www.facebook.com/webmonks.in.
