...
class CacheService
{
    ...
    {
        return Cache::remember(self::INSURANCE_COMPANIES_KEY, self::DEFAULT_TTL, function () {
    ...
    {
        return Cache::remember(self::BROKERS_KEY, self::DEFAULT_TTL, function () {
    ...
    {
        return Cache::remember(self::POLICY_TYPES_KEY, self::DEFAULT_TTL, function () {
    ...
    {
        return Cache::remember(self::PREMIUM_TYPES_KEY, self::DEFAULT_TTL, function () {
    ...
    {
        return Cache::remember(self::FUEL_TYPES_KEY, self::DEFAULT_TTL, function () {
    ...
    {
        return Cache::remember(self::USERS_KEY, self::DEFAULT_TTL, function () {
