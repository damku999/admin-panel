    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-3 mt-2">
            <div class="card-header py-2 d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-bold text-primary">Add New Add-on Cover</h6>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror"
                                    name="name" placeholder="Enter add-on cover name" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control form-control-sm @error('order_no') is-invalid @enderror"
                                    name="order_no" placeholder="Display order" value="{{ old('order_no', 0) }}" min="0">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-control-sm @error('description') is-invalid @enderror" 
                                    name="description" rows="4" placeholder="Enter add-on cover description">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card-footer py-2 bg-light">
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-success btn-sm px-4">
                            <i class="fas fa-save me-1"></i>Save Add-on Cover
                        </button>
                    </div>
                </div>
            </form>
