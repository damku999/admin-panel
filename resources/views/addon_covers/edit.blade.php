                ...
                <div class="card shadow mb-1">
                    <div class="card-header py-1">
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Add-on Cover</h6>
                ...
                @method('PUT')
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row g-2">
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <input type="text"
                                    ...
                                    id="name" placeholder="Add-on Cover Name" name="name"
                                    value="{{ old('name', $addon_cover->name) }}" required>
                            ...
                            <div class="col-md-3 col-sm-6 mb-1">
                                ...
                                <input type="number"
                                    ...
                                    id="order_no" placeholder="Display Order" name="order_no" 
                                    value="{{ old('order_no', $addon_cover->order_no) }}" min="0" required>
                        ...
                        <div class="mb-1">
                            ...
                            <textarea class="form-control form-control-sm @error('description') is-invalid @enderror" 
                                id="description" placeholder="Add-on Cover Description" name="description" rows="3">{{ old('description', $addon_cover->description) }}</textarea>
                    ...
                    <div class="card-footer p-2">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button type="submit" class="btn btn-success btn-sm">Update Add-on Cover</button>
                        </div>
                    </div>
                </form>
            </div>
