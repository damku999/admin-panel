...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Add-on Cover</h1>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 col-md-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text"
                                ...
                                placeholder="Add-on Cover Name" name="name"
                        ...
                        <div class="col-sm-3 col-md-3 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="number"
                                ...
                                placeholder="Display Order" name="order_no" 
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 mb-3 mt-3 mb-sm-0">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                placeholder="Add-on Cover Description" name="description" rows="4">{{ old('description') ? old('description') : $addon_cover->description }}</textarea>
