        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Edit Notification Template</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('notification-templates.update', $template) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('channel') is-invalid @enderror"
                                    ...
                                    <option value="both" {{ old('channel', $template->channel) === 'both' ? 'selected' : '' }}>Both</option>
                                </select>
                                @error('channel')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('template_content') is-invalid @enderror"
                                      id="template_content" name="template_content" rows="8" required>{{ old('template_content', $template->template_content) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('available_variables') is-invalid @enderror"
                                      id="available_variables" name="available_variables" rows="3">{{ old('available_variables', json_encode($template->available_variables)) }}</textarea>
