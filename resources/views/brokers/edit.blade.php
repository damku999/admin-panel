        ...
        <div class="card shadow">
            <div class="card-header py-1">
                <div class="d-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Broker</h6>
            ...
            <form method="POST" action="{{ route('brokers.update', ['broker' => $broker->id]) }}">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-4 col-sm-6 mb-1">
                            ...
                            <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror"
                                id="name" placeholder="Enter broker name" name="name"
                        ...
                        {{-- Mobile Number --}}
                        <div class="col-md-4 col-sm-6 mb-1">
                            <label for="mobile_number" class="form-label text-sm"><span class="text-danger">*</span>Mobile Number</label>
                            <input type="text" class="form-control form-control-sm @error('mobile_number') is-invalid @enderror"
                                ...
                                value="{{ old('mobile_number', $broker->mobile_number) }}" maxlength="10">
                            @error('mobile_number')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="card-footer py-1">
                    <div class="d-flex justify-content-end">
                        <a class="btn btn-secondary btn-sm mr-2" href="{{ route('brokers.index') }}">Cancel</a>
                        <button type="submit" class="btn btn-success btn-sm">
                            <i class="fas fa-save mr-1"></i>Update Broker
                        </button>
                    </div>
                </div>
            </form>
