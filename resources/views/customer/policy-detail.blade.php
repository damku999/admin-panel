                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="form-control-static h5 text-white">{{ $policy->policy_no ?? 'N/A' }}</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <p class="form-control-static">
                                    @if ($policy->final_premium_with_gst)
                                        <span
                                            class="h5 text-success font-weight-bold">₹{{ number_format($policy->final_premium_with_gst, 2) }}</span>
                                    @else
                                        N/A
                                    @endif
                                </p>
