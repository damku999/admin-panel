<!-- Modern Customer Delete Modal (Bootstrap 5) -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h6 class="mb-2">Are you sure you want to delete this customer?</h6>
                <p class="text-muted small mb-0">This action cannot be undone and will permanently remove the customer record and all associated policies and data.</p>
            </div>
