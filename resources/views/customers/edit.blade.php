...
@section('content')
    <div class="container-fluid">
            ...
            <div class="card-header py-3">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between">
                    <div>
                        ...
                        <small class="text-muted">Update customer information for {{ $customer->name }}</small>
                    </div>
                    <div class="mt-2 mt-md-0">
                        <x-buttons.action-button variant="outline-secondary" size="sm" icon="fas fa-arrow-left"
                            href="{{ route('customers.index') }}" title="Back to Customers List">
                            Back to Customers
                                ...
                                <div class="card-body pt-2">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            ...
                                            <select
                                                class="form-select form-select-sm select2-enable @error('type') is-invalid @enderror"
                                                name="type" id="customerType" data-placeholder="Select customer type"
                                                required>
                                                <option value="">Select customer type</option>
                                                <option value="Retail"
                                                    {{ old('type', $customer->type) == 'Retail' ? 'selected' : '' }}>
                                                    👤 Individual/Retail
                                                </option>
                                        ...
                                        {{-- Status --}}
                                        <div class="col-lg-4 col-md-6">
                                            <label for="status" class="form-label text-sm fw-bold">
                                                <span class="text-danger">*</span> Status
                                            </label>
                                            <select
                                                class="form-select form-select-sm select2-enable @error('status') is-invalid @enderror"
                                                name="status" id="status" data-placeholder="Select status" required>
                                                <option value="1"
                            ...
                            <div class="card border-0 bg-light">
                                ...
                                <div class="card-body pt-2">
                                    <div class="row g-3">
                                        {{-- Pan Card Number --}}
                                        <div class="col-lg-4 col-md-6">
                                            <label for="pan_card_number" class="form-label text-sm fw-bold">PAN Card
                                                Number</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="pan_card_number" name="pan_card_number"
                                            ...
                                            @enderror
                                            <small class="form-text text-muted">
                                                <i class="fas fa-info-circle me-1"></i>Format: ABCDE1234F (5 letters, 4
                                                digits, 1 letter)
                                            </small>
                                        </div>
                                        ...
                                        {{-- Pan Card Document --}}
                                        <div class="col-lg-4 col-md-6">
                                            <label for="pan_card_path" class="form-label text-sm fw-bold">PAN Card
                                                Document</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">
                                                ...
                                                <input type="file"
                                                    ...
                                                    id="pan_card_path" name="pan_card_path"
                                        ...
                                        {{-- Aadhar Card Number --}}
                                        <div class="col-lg-4 col-md-6">
                                            <label for="aadhar_card_number" class="form-label text-sm fw-bold">Aadhaar
                                                Card Number</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="aadhar_card_number" name="aadhar_card_number"
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <label for="aadhar_card_path" class="form-label text-sm fw-bold">Aadhaar Card
                                                Document</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">
                                                    <i class="fas fa-upload text-muted"></i>
                                                ...
                                                <input type="file"
                                                    ...
                                                    id="aadhar_card_path" name="aadhar_card_path"
                                                    accept=".pdf,.jpg,.jpeg,.png">
                                        ...
                                        <div class="col-lg-4 col-md-6" id="gstDocumentSection">
                                            <label for="gst_path" class="form-label text-sm fw-bold">GST
                                                Certificate</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">
                                                    <i class="fas fa-upload text-muted"></i>
                                                ...
                                                <input type="file"
                                                    ...
                                                    id="gst_path" name="gst_path" accept=".pdf,.jpg,.jpeg,.png">
                            ...
                            <div class="card border-0 bg-light">
                                ...
                                <div class="card-body pt-2">
                                    <div class="row g-3">
                                        {{-- Date of Birth --}}
                                        <div class="col-lg-4 col-md-6">
                                            <label for="date_of_birth" class="form-label text-sm fw-bold">Date of
                                                Birth</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <label for="engagement_anniversary_date"
                                                class="form-label text-sm fw-bold">Engagement Anniversary</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('engagement_anniversary_date', $customer->engagement_anniversary_date?->format('Y-m-d')) }}">
                                            </div>
                                        ...
                                        {{-- Wedding Anniversary --}}
                                        <div class="col-lg-4 col-md-6">
                                            <label for="wedding_anniversary_date"
                                                class="form-label text-sm fw-bold">Wedding Anniversary</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('wedding_anniversary_date', $customer->wedding_anniversary_date?->format('Y-m-d')) }}">
                                            </div>
                ...
                <div class="card-footer bg-light py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted">
                            <small><i class="fas fa-info-circle me-1"></i>Fields marked with <span
                                    class="text-danger">*</span> are required</small>
                        </div>
                        <div>
                            <x-buttons.action-button variant="outline-secondary" size="sm" icon="fas fa-times"
                                href="{{ route('customers.index') }}" title="Cancel and go back">
                                Cancel
                            </x-buttons.action-button>
        ...
        {{-- Customer Insurances Section --}}
        @if (auth()->user()->hasPermissionTo('customer-insurance-list') &&
                !empty($customer_insurances) &&
                count($customer_insurances) > 0)
            <div class="card shadow mt-4">
                <div class="card-header py-3 bg-gradient-primary">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="mb-0 text-white font-weight-bold">
                                <i class="fas fa-shield-alt me-2"></i>Customer Insurance Policies
                            </h6>
                            <small class="text-white-50">Active insurance policies for this customer</small>
                        </div>
                        <span class="badge badge-light">{{ count($customer_insurances) }} Policies</span>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped mb-0">
                            <thead class="table-dark">
                                <tr>
                                    <th class="text-sm">Added</th>
                                    <th class="text-sm">Issue Date</th>
                                    <th class="text-sm">Expiry</th>
                                    <th class="text-sm">Policy No.</th>
                                    <th class="text-sm">Registration</th>
                                    <th class="text-sm">Premium Type</th>
                                    <th class="text-center text-sm">Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($customer_insurances as $customer_insurance)
                                    <tr>
                                        <td class="text-sm">
                                            <small
                                                class="text-muted">{{ $customer_insurance->created_at->format('d M Y') }}</small>
                                        </td>
                                        <td class="text-sm">
                                            @if ($customer_insurance->policy_issue_date)
                                                <span
                                                    class="badge bg-info">{{ \Carbon\Carbon::parse($customer_insurance->policy_issue_date)->format('d M Y') }}</span>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
                                        <td class="text-sm">
                                            @if ($customer_insurance->policy_expiry_date)
                                                @php
                                                    $expiryDate = \Carbon\Carbon::parse(
                                                        $customer_insurance->policy_expiry_date,
                                                    );
                                                    $isExpired = $expiryDate->isPast();
                                                    $isExpiring = $expiryDate->diffInDays(now()) <= 30 && !$isExpired;
                                                @endphp
                                                <span
                                                    class="badge {{ $isExpired ? 'bg-danger' : ($isExpiring ? 'bg-warning' : 'bg-success') }}">
                                        ...
                                        <td class="text-sm">
                                            @if ($customer_insurance->policy_number)
                                                <code class="text-primary">{{ $customer_insurance->policy_number }}</code>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
                                        <td class="text-sm">
                                            @if ($customer_insurance->registration_number)
                                                <span
                                                    class="badge bg-secondary">{{ $customer_insurance->registration_number }}</span>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
                                        <td class="text-sm">
                                            @if ($customer_insurance->premiumType)
                                                <span
                                                    class="badge bg-light text-dark">{{ $customer_insurance->premiumType->name }}</span>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
                                        <x-tables.action-column>
                                            @if (auth()->user()->hasPermissionTo('customer-insurance-edit'))
                                                <x-buttons.action-button variant="primary" size="sm"
                                                    icon="fas fa-edit"
                                                    href="{{ route('customer_insurances.edit', ['customer_insurance' => $customer_insurance->id]) }}"
                                            ...
                                            @if (auth()->user()->hasPermissionTo('customer-insurance-delete'))
                                                <x-buttons.action-button variant="danger" size="sm"
                                                    ...
                                                    onclick="delete_conf_common('{{ $customer_insurance->id }}','Insurance Policy','{{ $customer_insurance->policy_number }}', '{{ route('customers.edit', ['customer' => $customer->id]) }}')"
    ...
    <script>
        $(document).ready(function() {
            ...
            form.on('submit', function(e) {
                ...
                requiredFields.each(function() {
                    ...
                    if (!value) {
                        ...
                        if (!field.siblings('.invalid-feedback').length) {
                            field.after(
                                '<div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>This field is required</div>'
                                );
                        }
                    } else {
                ...
                submitBtn.html('<i class="fas fa-spinner fa-spin me-1"></i>Updating Customer...');
            ...
            $('#email').on('blur', function() {
                ...
                if (email && !emailRegex.test(email)) {
                    ...
                    if (!$(this).siblings('.invalid-feedback').length) {
                        $(this).after(
                            '<div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>Please enter a valid email address</div>'
                            );
                    }
                } else if (email) {
                    $(this).removeClass('is-invalid').addClass('is-valid');
            ...
            $('input[type="file"]').on('change', function() {
                ...
                if (file) {
                    ...
                    if (file.size > maxSize) {
                        ...
                        if (!$(this).siblings('.invalid-feedback').length) {
                            $(this).after(
                                '<div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>File size must be less than 5MB</div>'
                                );
                        }
                    ...
                    if (!allowedTypes.includes(file.type)) {
                        ...
                        if (!$(this).siblings('.invalid-feedback').length) {
                            $(this).after(
                                '<div class="invalid-feedback"><i class="fas fa-exclamation-circle me-1"></i>Only PDF, JPG, and PNG files are allowed</div>'
                                );
                        }
                        $(this).val(''); // Clear the file
                        return;
