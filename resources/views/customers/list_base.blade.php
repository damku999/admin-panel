...
@php
    $list_url = 'list_customer';
    $module_name = 'Customers';
    $excel_url = 'excel_customer';
@endphp
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 750px;">
                                <input type="text" placeholder="Search" name="search_box_customer"
                                    class="form-control float-right filter_by_key"
                                    value="{{ Session::get('search_box_customer') }}">
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ url(Config::get('constants.ADMIN_URL') . 'customer/create') }}"
