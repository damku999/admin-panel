...
@php
    $list_url = 'list_fuel_type';
    $module_name = 'Fuel Type';
    $excel_url = 'excel_fuel_type';
@endphp
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 750px;">
                                <input type="text" placeholder="Search" name="search_box_fuel_type"
                                    class="form-control float-right filter_by_key"
                                    value="{{ Session::get('search_box_fuel_type') }}">
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ url(Config::get('app.url') . 'fuel_type/create') }}"
