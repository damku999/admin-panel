...
@section('content')
    @php
        ...
        function getChangePercentage($currentValue, $previousValue)
        {
            ...
            return '<span class="metric-change ' . $class . '">' . ($change > 0 ? '+' : '') . number_format($change, 1) . '%</span>';
        }
    ...
    <div class="container-fluid">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th>Metric</th>
                                        <th class="text-center">Today<br><small class="text-muted">{{ formatDateForUi($data['date']) }}</small></th>
                                        <th class="text-center">Yesterday<br><small class="text-muted">{{ formatDateForUi($data['yesterday']) }}</small></th>
                                        <th class="text-center">Day Before<br><small class="text-muted">{{ formatDateForUi($data['day_before_yesterday']) }}</small></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th>Metric</th>
                                        <th class="text-center">Current Year<br><small class="text-muted">{{ \Carbon\Carbon::parse($data['financial_year_start'])->format('M-Y') }} to {{ \Carbon\Carbon::parse($data['financial_year_end'])->format('M-Y') }}</small></th>
                                        <th class="text-center">Last Year<br><small class="text-muted">{{ \Carbon\Carbon::parse($data['previous_financial_year_start'])->format('M-Y') }} to {{ \Carbon\Carbon::parse($data['previous_financial_year_end'])->format('M-Y') }}</small></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        @foreach ($data['quarters_data'] as $quarter)
                                            <th class="text-center">
                                                ...
                                                <small class="text-muted">
                                                    {{ \Carbon\Carbon::parse($data['quarter_date'][$loop->iteration - 1]['quarter_start'])->format('M-Y') }} to
        ...
        <div class="row mb-4">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 mb-3">
                <div class="card card-metric card-primary h-100" onclick="redirectToCustomerInsuranceIndex()" style="cursor: pointer;">
                    <div class="card-body">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 mb-3">
                <div class="card card-metric card-success h-100" onclick="redirectToCustomerInsuranceIndex(1)" style="cursor: pointer;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 mb-3">
                <div class="card card-metric card-warning h-100" onclick="redirectToCustomerInsuranceIndex(0,1)" style="cursor: pointer;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-3 col-6 mb-3">
                                <div class="card card-metric card-primary h-100" onclick="redirectToPolicyList()" style="cursor: pointer;">
                            ...
                            <div class="col-lg-3 col-6 mb-3">
                                <div class="card card-metric card-success h-100" onclick="redirectToPolicyList('active')" style="cursor: pointer;">
                                    <div class="card-body text-center">
                            ...
                            <div class="col-lg-3 col-6 mb-3">
                                <div class="card card-metric card-warning h-100" onclick="redirectToPolicyList('inactive')" style="cursor: pointer;">
                                    <div class="card-body text-center">
                            ...
                            <div class="col-lg-3 col-6 mb-3">
                                <div class="card card-metric card-danger h-100" onclick="redirectToPolicyList('expiring')" style="cursor: pointer;">
                                    <div class="card-body text-center">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 mb-3">
                                <div class="card card-metric card-primary h-100" onclick="redirectToCustomerList()" style="cursor: pointer;">
                                    <div class="card-body text-center">
                            ...
                            <div class="col-6 mb-3">
                                <div class="card card-metric card-success h-100" onclick="redirectToCustomerList('active')" style="cursor: pointer;">
                                    <div class="card-body text-center">
                            ...
                            <div class="col-6 mb-3">
                                <div class="card card-metric card-warning h-100" onclick="redirectToCustomerList('inactive')" style="cursor: pointer;">
                                    <div class="card-body text-center">
