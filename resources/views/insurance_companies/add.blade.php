...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Insurance Companies</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Add New Relationship Manager</h6>
            </div>
            <form method="POST" action="{{ route('insurance_companies.store') }}">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-success btn-insurance_company float-right mb-3">Save</button>
