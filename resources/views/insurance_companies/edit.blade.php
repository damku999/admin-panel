        ...
        <div class="card shadow">
            <div class="card-header py-1">
                <div class="d-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Insurance Company</h6>
            ...
            <form method="POST" action="{{ route('insurance_companies.update', ['insurance_company' => $insurance_company->id]) }}">
                ...
                <div class="card-body p-2">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-4 col-sm-6 mb-1">
                            <label for="name" class="form-label text-sm"><span class="text-danger">*</span>Company Name</label>
                            <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror"
                                id="name" placeholder="Enter insurance company name" name="name"
                                value="{{ old('name', $insurance_company->name) }}">
                            @error('name')
                        ...
                        <div class="col-md-4 col-sm-6 mb-1">
                            ...
                            <input type="email" class="form-control form-control-sm @error('email') is-invalid @enderror"
                                ...
                                value="{{ old('email', $insurance_company->email) }}">
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-1">
                            ...
                            <input type="text" class="form-control form-control-sm @error('mobile_number') is-invalid @enderror"
                                ...
                                value="{{ old('mobile_number', $insurance_company->mobile_number) }}" maxlength="10">
                            @error('mobile_number')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="card-footer py-1">
                    <div class="d-flex justify-content-end">
                        <a class="btn btn-secondary btn-sm mr-2" href="{{ route('insurance_companies.index') }}">Cancel</a>
                        <button type="submit" class="btn btn-success btn-sm">
                            <i class="fas fa-save mr-1"></i>Update Insurance Company
                        </button>
                    </div>
                </div>
            </form>
