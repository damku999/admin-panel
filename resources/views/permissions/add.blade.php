            ...
            <form method="POST" action="{{ route('permissions.store') }}">
                ...
                <div class="card-body p-2">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6 col-sm-12 mb-1">
                            <label for="name" class="form-label text-sm"><span class="text-danger">*</span>Permission Name</label>
                            <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror"
                                id="name" placeholder="Enter permission name" name="name"
                                value="{{ old('name') }}">
                            @error('name')
                ...
                <div class="card-footer py-1">
                    <div class="d-flex justify-content-end">
                        <a class="btn btn-secondary btn-sm mr-2" href="{{ route('permissions.index') }}">Cancel</a>
