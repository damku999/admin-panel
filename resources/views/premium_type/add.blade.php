        ...
        <div class="card shadow">
            <div class="card-header py-1">
                <div class="d-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Add Premium Type</h6>
                            ...
                            <div class="form-check-container">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_vehicle"
                                        value="1" id="vehicle_yes" {{ old('is_vehicle') == '1' ? 'checked' : '' }}>
                                    <label class="form-check-label text-sm" for="vehicle_yes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_vehicle"
                                        value="0" id="vehicle_no" {{ old('is_vehicle', '0') == '0' ? 'checked' : '' }}>
                            ...
                            <div class="form-check-container">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_life_insurance_policies"
                                        value="1" id="life_insurance_yes" {{ old('is_life_insurance_policies') == '1' ? 'checked' : '' }}>
                                    <label class="form-check-label text-sm" for="life_insurance_yes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_life_insurance_policies"
                                        value="0" id="life_insurance_no" {{ old('is_life_insurance_policies', '0') == '0' ? 'checked' : '' }}>
                ...
                <div class="card-footer py-1">
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-success btn-sm">
                            <i class="fas fa-save mr-1"></i>Create Premium Type
                        </button>
                    </div>
                </div>
            </form>
