...
@php
    $list_url = 'list_premium_type';
    $module_name = 'Premium Type';
    $excel_url = 'excel_premium_type';
@endphp
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 750px;">
                                <input type="text" placeholder="Search" name="search_box_premium_type"
                                    class="form-control float-right filter_by_key"
                                    value="{{ Session::get('search_box_premium_type') }}">
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ url(Config::get('app.url') . 'premium_type/create') }}"
