...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Reference User</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Add New Reference User</h6>
            </div>
            <form method="POST" action="{{ route('reference_users.store') }}">
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('reference_users.index') }}">Cancel</a>
                </div>
            </form>
        </div>
