...
@php
    $list_url = 'list_reference_user';
    $module_name = 'Reference User';
    $excel_url = 'excel_reference_user';
@endphp
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 750px;">
                                <input type="text" placeholder="Search" name="search_box_reference_user"
                                    class="form-control filter_by_key"
                                    value="{{ Session::get('search_box_reference_user') }}">
                                <div class="input-group-text">
                                    ...
                                    <a href="{{ url(config('app.url') . 'reference_users/create') }}"
