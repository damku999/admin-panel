...
@php
    $list_url = 'list_broker';
    $module_name = 'Reference User';
    $excel_url = 'excel_broker';
@endphp
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 750px;">
                                <input type="text" placeholder="Search" name="search_box_broker"
                                    class="form-control float-right filter_by_key"
                                    value="{{ Session::get('search_box_broker') }}">
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ url(Config::get('app.url') . 'broker/create') }}"
