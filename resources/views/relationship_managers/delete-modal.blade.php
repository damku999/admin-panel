<!-- Modern Relationship Manager Delete Modal (Bootstrap 5) -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h6 class="mb-2">Are you sure you want to delete this relationship manager?</h6>
                <p class="text-muted small mb-0">This action cannot be undone and will permanently remove the manager record and all associated data.</p>
            </div>
            <div class="modal-footer border-0 pt-0">
                ...
                <a class="btn btn-danger" href="{{ route('logout') }}"
                    ...
                    <i class="fas fa-trash me-1"></i> Delete Manager
                </a>
