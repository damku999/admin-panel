    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-3 mt-2">
            <div class="card-header py-2 d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-bold text-primary">Edit Relationship Manager</h6>
            ...
            <form method="POST" action="{{ route('relationship_managers.update', ['relationship_manager' => $relationship_manager->id]) }}">
                ...
                <div class="card-body py-3">
                    <!-- Section: Relationship Manager Information -->
                    <div class="mb-3">
                        <h6 class="text-muted fw-bold mb-3"><i class="fas fa-user-friends me-2"></i>Relationship Manager Information</h6>
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label fw-semibold"><span class="text-danger">*</span> Name</label>
                                <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror"
                                    name="name" placeholder="Enter manager name" 
                ...
                <div class="card-footer py-2 bg-light">
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm px-4">
                            <i class="fas fa-save me-1"></i>Update Relationship Manager
                        </button>
                    </div>
                </div>
            </form>
