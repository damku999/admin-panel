...
@php
    $list_url = 'list_reports';
    $module_name = 'Reports';
    $excel_url = 'excel_reports';
@endphp
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 750px;">
                                <input type="text" placeholder="Search" name="search_box_reports"
                                    class="form-control float-right filter_by_key"
                                    value="{{ Session::get('search_box_reports') }}">
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ url(Config::get('app.url') . 'reports/create') }}"
