    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-3 mt-2">
            <div class="card-header py-2 d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-bold text-primary">Add New User</h6>
            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="card-body py-3">
                    ...
                    <div class="mb-3">
                        <h6 class="text-muted fw-bold mb-3"><i class="fas fa-lock me-2"></i>Password Information</h6>
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="password" class="form-control form-control-sm @error('new_password') is-invalid @enderror"
                                    name="new_password" placeholder="Enter password" autocomplete="new-password">
                                @error('new_password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold"><span class="text-danger">*</span> Confirm Password</label>
                                <input type="password" class="form-control form-control-sm @error('new_confirm_password') is-invalid @enderror"
                                    name="new_confirm_password" placeholder="Confirm password" autocomplete="new-password">
